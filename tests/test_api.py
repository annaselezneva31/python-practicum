...
async def test_get_latest_fact_from_cache(api_client, mock_redis_client):
    fake_redis_value = {"id": str(uuid4()), "text": "New fact:Dogs", "source": "http://dogs.com", "created_at": "2024-01-01T00:00:00"}
...
async def test_cache_populated_after_db_miss(api_client, added_fact, mock_redis_client, db_container):
    # cache is empty
